...
OuterElectrodeRingRad=2.5; #Radius of the Outer Electrode Ring
InnerElectrodeRingRad=2.5; #Radius of the Inner Electrode Ring
GroundRingRad=0
CavityLength= 100; # length of the Cavity (cm)
CavityRadius= 10; # Radius of Cavity (cm)
...
coz2=0.75*CavityLength-InnerPlateDepth/2; # Middle plate is centered
